...
function baseConvolve(
    ...
    channelCallback = typeof channelCallback === 'function' ?
        channelCallback :
        _.identity;
...
export abstract class ConvolutionFilter
    ...
    /** 
     * Performs a vertical convolution on a single-channel matrix.
     */
    convolveVGray(
        kernel: Kernel,
        srcData: Uint8ClampedArray,
    ...
    /**
     * Performs a raw convolution on a single-channel image matrix.
     */
    baseConvolveSingleChannel(
        kernel: Kernel,
        srcData: TypedArray,
        dstData: TypedArray,
        width: number,
